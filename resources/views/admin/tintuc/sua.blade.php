        ...
        <div class="row">
            ...
            <div class="col-lg-7" style="padding-bottom:120px">
                ...
                <form action="admin/tintuc/sua/{{$tintuc->id}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label>Tiêu đề</label>
                        <input name="TieuDe" class="form-control" placeholder="Nhập tiêu đề" value="{{$tintuc->TieuDe}}"/>
                    </div>
                    <div class="form-group">
                        <label>Tóm tắt</label>
            ...
            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                ...
                <tbody>
                    ...
                    <tr class="odd gradeX" align="center">
                        ...
                        <td>{{$cm->NoiDung}}</td>
                        <td>{{$cm->created_at}}</td>
                        <td class="center"><i class="fa fa-trash-o  fa-fw"></i><a href="admin/comment/xoa/{{$cm->id}}/{{$tintuc->id}}" onclick="return xoa()"> Delete</a></td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
